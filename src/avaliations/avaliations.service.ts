...
export class AvaliationsService {
    ...
    async findAll(params: any): Promise<{ data: Avaliation[]; total: number }> {
        ...
        if (params.title)
            query.andWhere("avaliation.title like :title", {
                title: `%${params.title}%`,
            });
        if (params.year)
            query.andWhere("avaliation.year = :year", { year: params.year });
    ...
    update(
        hash: string,
        updateAvaliationDto: UpdateAvaliationDto,
    ): Promise<any> {
    ...
    getDisciplineFileMock() {
        const sectionItem1: DcpQuestion = {
          ...
          <p>Considere um atleta que antes do treinamento apresentava 55 kg e que necessita chegar ao peso de 60 kg, em um mês. Fazendo unicamente esse treinamento, será possível alcançar o resultado esperado?</p>`,
                    image_source:
                        "http://localhost:3000/public/examples/avaliation/images/question-1-image-1.png",
                    caption: "Função Afim",
                },
            ],
            options: [
        ...
        const sectionItem2: DcpQuestion = {
            ...
            header: [
                {
                    image_source:
                        "http://localhost:3000/public/examples/avaliation/images/question-2-image-1.png",
                },
            ],
            options: [
                {
                    hash: "<UUID>",
                    option_text:
                        "necessidade de acessar informações confidenciais.",
                },
                {
                    hash: "<UUID>",
                ...
                },
                {
                    hash: "<UUID>",
                    option_text:
                        "desafio de permanecer imparcial. E vontade de ler notícias positivas.",
                },
                {
                    hash: "<UUID>",
        ...
        const sectionItem3: DcpQuestion = {
            _comment:
                "Enem 2022 Caderno 1 - AZUL - 1ª Aplicação, Página 6 - Questão 7",
            hash: "<UUID>",
            type: DcpSectionItemType.QUESTION,
            question_type: DcpQuestionType.RADIO,
            header: [
                {
                    title: "TEXTO I",
                    image_source:
                        "http://localhost:3000/public/examples/avaliation/images/question-3-image-1.png",
                    caption:
                ...
                },
                {
                    ...
                    caption:
                        "COSTA, A. R. N. Viver o amor aos cães: Parque Francisco de Assis.<br/> Carmo do Cachoeira: Irdin, 2014 (adaptado)",
                },
                {
                    statement:
        ...
        let data: DisciplineFileData = {
            ...
            title: "Enem 2020",
            description:
                "Arquivo Discipline de Teste 2 - Prova do 1º Dia - Caderno 1 – Azul – Aplicação Regular - https://www.gov.br/inep/pt-br/areas-de-atuacao/avaliacao-e-exames-educacionais/enem/provas-e-gabaritos",
